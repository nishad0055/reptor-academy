        ...
        <div className="relative flex items-center justify-between">
          ...
          <li>
            ...
            <li>
              <Link
                to= '/register'
                className="inline-flex items-center justify-center h-9 px-6 font-medium tracking-wide text-white transition duration-200 rounded-2xl shadow-md bg-yellow-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
              >
                Sign up
              </Link>
            </li>
