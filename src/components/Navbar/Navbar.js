  ...
  const handlelogOut = () =>{
    ...
    return (
        <div className='bg-black w-full' >
          <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 bg-transparent text-white">
          ...
          <div className="lg:hidden">
            ...
            {isMenuOpen && (
              <div className="absolute top-10 left-0 w-full">
                <div className="p-5 bg-white  border rounded shadow-sm transition-all">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div>
                      ...
                      >
                        <svg className="text-2xl w-5 text-gray-600" viewBox="0 0 24 24">
                          <path
                            fill="currentColor"
